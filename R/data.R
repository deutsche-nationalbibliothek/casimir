...
#'
#' A subset of documents found in the catalogue of the DNB with intelectually
...
#'   \item{rank}{ranks based on the score-columns}
#' }
...
#' frequencies of occurence. The label_ids match those in the
